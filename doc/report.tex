...
\begin{document}
	...
	\subsection{Analisi}
	Scopo di questa parte dell'assignment \'e l'implementazione di una libreria asincrona in grado di "parsare" file sorgente di java mediante l'utilizzo dell'event loop fornito da \href{https://vertx.io/}{Vert.x}. Abbiamo utilizzato la libreria \href{https://javaparser.org/}{Java Parser} per la fase di parsing dei file.
